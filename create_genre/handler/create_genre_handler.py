...
def validate_request(payload) :
    ...
    required_fields = ['customer_id', 'genre_type']
...
def lambda_handler(event, context) :
    ...
    error_codes = {
        ...
        'GenreNotCreated' : {
            'message' : 'Some error occured while creating a new genre',
            'code' : '004'
        }
    }
    ...
    if is_request_valid_response_code == 200 :
        try :
            ...
            try :
                ...
                query_response = create_genre(event)
                ...
                print("Something error occured while creating the genre :",err)
