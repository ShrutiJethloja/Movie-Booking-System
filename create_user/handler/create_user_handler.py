...
def validate_request(payload) :
    ...
    if 'phone_number' in payload and payload['phone_number'] != "" :
        ...
        phone_number_check_pattern = r'^\+91[7-9]\d{9}$'
        if not re.match(phone_number_check_pattern, phone_number) :
    ...
    if 'email' in payload and payload['email'] != "" :
        ...
        email = payload['email']
        email_check_pattern = r'\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Z|a-z]{2,7}\b'
        if not re.match(email_check_pattern, email) :
    ...
    if is_request_valid_response_code == 200 :
        try :
            ...
            try :
                ...
                query_response = create_user(event)
            ...
            try: 
                ...
                query_response = query_response['insert_customer']
